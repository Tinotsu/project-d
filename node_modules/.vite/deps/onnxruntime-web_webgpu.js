...
var Yf = (a, r, s, f) => {
	if (r && typeof r == "object" || typeof r == "function") for (let i of Hf(r)) !qf.call(a, i) && i !== s && Hr(a, i, {
		get: () => r[i],
		enumerable: !(f = jf(r, i)) || f.enumerable
	});
	return a;
};
var zt = (a) => Yf(Hr({}, "__esModule", { value: !0 }), a);
var Vt;
var Ke;
var Qe;
var Jf;
...
var es = k(() => {
	...
	je();
	Yt();
	Za = "ort-wasm-proxy-worker", Ka = globalThis.self?.name === Za;
	Ka && (self.onmessage = (a) => {
...
async function ts(a = {}) {
	...
	async function bt() {
		function e(o, u) {
			...
			return ke = o, ke = (function() {
				...
				return (h = Object.assign({}, h)).ac = b(h.ac), h.Dc = E(h.Dc), h.Fc = b(h.Fc), h.sd = ((I) => (F, j) => I(F, j) >>> 0)(h.sd), h.xd = b(h.xd), h.yd = E(h.yd), h.Cd = b(h.Cd), h;
	...
	function Sn(e, t, n, o) {
		...
		return i && u.length === 0 ? En(e, t, n, o) : (e = {
			...
			Xc: o,
			Zc: u
		}, i ? (e.Pc = "spawnThread", postMessage(e, u), 0) : K(e));
	}
	function Ks(e) {
		throw ft ||= e >>> 0, ft;
	}
	...
	var Fn = (e, t, n) => {
		switch (t) {
			...
			case 2: return n ? (o) => (p(), Ce)[o >>> 1 >>> 0] : (o) => (p(), Z)[o >>> 1 >>> 0];
	...
	function ti(e, t, n, o, u) {
		...
		De(e, {
			name: t,
			Nc: c,
			Tc: (h, b) => (typeof b == "number" && (b = BigInt(b)), b),
			Sc: Fn(t, n, !o),
			Uc: null
		});
	}
	...
	function Ti(e, t) {
		(e >>>= 0) == t >>> 0 ? setTimeout(Pt) : i ? postMessage({
			Wc: e,
			Pc: "checkMailbox"
		}) : (e = Je[e]) && e.postMessage({ Pc: "checkMailbox" });
	}
	var xr = [];
  ...
  ${b}
	...
	function Ou(e, t, n, o) {
		if (t = ce(t), o >>>= 0, n >>>= 0) {
			var u = {
				featureLevel: pu[(p(), x)[n + 4 >>> 2 >>> 0]],
				powerPreference: mu[(p(), x)[n + 8 >>> 2 >>> 0]],
	...
	var lo, po, Pr, Ft, xe, pt, mo, ho, yo, bo, wo, go, To, vo, Eo, So, Ao, _r, Rr, Nr, kr, Et, Wr, Io, Fr, xo, Lo, Bo, Gr, Oo, Mo, $r, N, St, Uo, D, Gt, P, Co, zr, Do, Po, _o, Vr, Ro, No, ko, Wo, Fo, Go, $o, zo, Vo, jo, Ho, qo, Yo, Jo, Xo, Zo, Ko, Qo, ea, ta, ra, na, oa, aa, sa, ia, ua, fa, ca, da, la, pa, ma, ha, ya, ba, wa, ga, Ta, ke, af = [
		Ye,
		br,
		En,
		Ln,
...
var ns = k(() => {
	"use strict";
	Kf = ts, Qf = globalThis.self?.name?.startsWith("em-pthread");
	Qf && ts();
});
var ss;
var rn;
...
var Yt = k(() => {
	"use strict";
	qt();
	ss = typeof location > "u" ? void 0 : location.origin, rn = import.meta.url > "file:" && import.meta.url < "file;", ec = () => {
		if (rn) return new URL(new URL("ort.webgpu.bundle.min.mjs", import.meta.url).href, ss).href;
...
var un = k(() => {
	...
	dc = [
		...
		let s = Ot(a);
		s >= Ot(ws) && lc(s, typeof r == "function" ? r() : r);
	}, pe = (...a) => {
		gs && pc(...a);
	};
});
...
var xs = k(() => {
	...
	Es = /* @__PURE__ */ new Map([
	...
	}, mc = 1, vs = () => mc++, hc = /* @__PURE__ */ new Map([
		["int8", "int32"],
		["uint8", "int32"],
		["uint32", "int32"],
		["int64", "int32"]
		...
		registerTensor(r, s, f, i) {
			let d = this.getMLContext(r), l = vs(), m = new ur({
				sessionId: r,
				context: d,
				tensor: s,
				dataType: f,
...
var en = k(() => {
	...
	bc = (a, r) => {
		...
		try {
			...
			let q = null;
			return M.some((B) => B === "gpu-buffer" || B === "ml-tensor" || B === "ml-tensor-cpu-output") && (m = i._OrtCreateBinding(d), m === 0 && $("Can't create IO binding."), q = {
				handle: m,
				outputPreferredLocations: M,
				outputPreferredLocationsEncoded: M.map((B) => B === "ml-tensor-cpu-output" ? "ml-tensor" : B).map((B) => an(B))
			}), it.set(d, [
				d,
				w,
				T,
			...
			for (let _ = 0; _ < H; _++) {
				...
				try {
					...
					if (re === "string") {
						...
						let K = new (at(re))(Ae);
						new Uint8Array(K.buffer, K.byteOffset, K.byteLength).set(l.HEAPU8.subarray(se, se + K.byteLength)), x.push([
							re,
							Se,
							K,
							"cpu"
...
var mn = k(() => {
	...
	je();
	Yt();
	ut = () => !!Q.wasm.proxy && typeof document < "u", Ut = !1, lr = !1, pr = !1, pn = /* @__PURE__ */ new Map(), ht = (a, r) => {
		let s = pn.get(a);
...
Object.defineProperty(Q.versions, "web", {
	value: Xa,
	enumerable: !0
});
//#endregion
export { Xf as InferenceSession, $a as TRACE, $e as TRACE_EVENT_BEGIN, ze as TRACE_EVENT_END, tt as TRACE_FUNC_BEGIN, rt as TRACE_FUNC_END, Le as Tensor, vl as default, Q as env, Qe as registerBackend };
